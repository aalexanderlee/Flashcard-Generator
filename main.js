...
//node main.js basic-card ---> activates BasicCard.js
//try encapsulating all of BasicCard.js into one outer main function you can call on from here
if (process.argv[2] === "basic-card") {
	//go to function in BasicCard.js to prompt user
}


//node main.js cloze-card ---> activiates ClozeCard.js
//try encapsulating all of ClozeCard.js into one outer main function you can call on from here
